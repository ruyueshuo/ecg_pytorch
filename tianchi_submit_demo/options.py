...
class Options(object):
    ...
    def __init__(self):
        ...
        # Base
        self.parser.add_argument('--root', default=r'/home/algo/PycharmProjects/ecg_pytorch/data', help='root of data')
        ...
        self.parser.add_argument('--num_classes', type=int, default=34, help='label的类别数.')
        ...
        self.parser.add_argument('--sub_dir', type=str, default='./')
    ...
    def parse(self):
        ...
        self.opt.train_dir = os.path.join(self.opt.root, 'hf_round2_train')
        # self.opt.tst_dir = os.path.join(self.opt.root, 'hf_round1_testA')
        self.opt.test_dir = r'/tcdata/hf_round2_testA/'
        self.opt.train_label = os.path.join(self.opt.root, 'hf_round2_train.txt')
        self.opt.test_label = r'/tcdata/hf_round2_subA.txt'
        self.opt.arrythmia = r'./hf_round2_arrythmia.txt'
        self.opt.train_data = r'./train.pth'
